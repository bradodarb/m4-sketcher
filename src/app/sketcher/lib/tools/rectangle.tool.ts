...
import { Horizontal, Vertical } from '../constraints';
...
export class RectangleTool extends Tool {
  ...
  public rectangle: Array<Segment>;
  public firstPointSnap = null;
  public snapExclude = [];
  ...
  stepFinish(p) {
    ...
    const constraints = [
      new Horizontal(this.rectangle[0]),
      new Horizontal(this.rectangle[2]),
      new Vertical(this.rectangle[3]),
      new Vertical(this.rectangle[1])
    ];
