import { EndPoint, BezierCurve } from '../geometry/render-models';
import { Tool } from './tool'
import Vector from '../math/vector'
import * as math from '../math/math';
import { Viewport2d } from '../viewport';
import { Parallel } from '../constraints';

export class BezierCurveTool extends Tool {

  public _v: Vector;
  public curve: BezierCurve;
  public snappedControl: Vector;
  public otherCurveEndPoint: EndPoint;
  ...
  mouseup(e) {
    if (this.curve == null) {
      ...
      if (this.otherCurveEndPoint != null) {
        this.viewer.parametricManager.add(new Parallel(this.otherCurveEndPoint.parent, this.curve.a.parent));
      }
