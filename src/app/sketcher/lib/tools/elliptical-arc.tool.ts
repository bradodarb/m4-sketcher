...
import { EndPoint, EllipticalArc } from '../geometry/render-models';
  ...
  mousemove(e) {
    ...
    switch (this.state) {
      ...
      case STATE_RADIUS:
        ...
        let minorRadius = EllipticalArc.findMinorRadius(this.ellipse.radiusX, polarPoint.radius, polarPoint.angle);
